...
import { Check, MapPin, Mountain, Trees, UtensilsCrossed, Car, Wifi } from "lucide-react";
...
export const Route = createFileRoute("/homestay-in-theog")({
  head: () => ({
    meta: [
      { title: "Homestay in Theog, Himachal Pradesh | Alpine Crest Homestay" },
      {
        name: "description",
        content:
          "Looking for a peaceful homestay in Theog, Himachal Pradesh? Alpine Crest Homestay is located in Kathot near Theog and offers comfortable rooms, private balconies, mountain views and warm local hospitality.",
      },
      { property: "og:title", content: "Homestay in Theog, Himachal Pradesh | Alpine Crest Homestay" },
      {
        property: "og:description",
        content:
          "Peaceful homestay in Kathot near Theog, Himachal Pradesh. Mountain views, private balconies, home-cooked food and warm hospitality.",
      },
  ...
  component: HomestayInTheogPage,
});

function HomestayInTheogPage() {
  return (
    <>
      ...
      <section className="container-page grid items-center gap-10 py-12 lg:grid-cols-2">
        <div>
          ...
          <h1 className="mt-3 text-4xl leading-[1.1] sm:text-5xl">
            Homestay in Theog, Himachal Pradesh – Alpine Crest Homestay
          </h1>
          <p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground">
            Looking for a peaceful homestay in Theog, Himachal Pradesh? Alpine
            Crest Homestay is located in Kathot near Theog and offers comfortable
            rooms, private balconies, mountain views and warm local hospitality.
          </p>
        ...
        <div className="overflow-hidden rounded-2xl shadow-soft">
          <img
            src={exterior}
            alt="Alpine Crest Homestay in Kathot near Theog, Himachal Pradesh"
            width={1360}
            height={1020}
            loading="eager"
      ...
      <section className="container-page grid gap-10 py-12 lg:grid-cols-2">
        <div className="prose-stay">
          <h2>A Peaceful Homestay Near Theog</h2>
          <p>
            Theog is a small hill town on NH-5, about an hour east of Shimla. Most
            travellers only pass through it on the way to Kufri or Narkanda, but
            the ridge around Theog — and villages like Kathot just off the
            highway — hold some of the quietest mountain views in the upper
            Shimla hills. Alpine Crest Homestay is set just above the apple
            orchards of Kathot, where the road leaves the highway traffic behind
            and the only sounds are wind through the deodars and distant temple
            bells.
          </p>
          <p>
            As a homestay in Theog, we keep things simple and personal. The house
            is run by the family that lives here, so you get genuine local
            hospitality rather than hotel formality — directions to the best
            sunrise spot, a cup of chai when you arrive, and a kitchen that cooks
            what is in season.
          </p>

          <h2>Why Stay at Alpine Crest Homestay in Theog?</h2>
          <ul>
          ...
          <p>
            Theog is well placed as a base for the upper Shimla hills. Kufri is
            about 30 minutes away for the Himalayan Nature Park and winter snow;
            Fagu is a short drive for quiet viewpoints; Narkanda, further along
            NH-5, offers Hatu Peak and the apple belt of Kotgarh; and Shimla town
            is an hour west if you want a day trip to the Ridge and Mall Road.
          </p>
        </div>
      ...
      <section className="bg-secondary/60 py-16">
        <div className="container-page">
          ...
          <h2 className="mt-3 text-3xl">Everything you actually need</h2>
      ...
      <section className="container-page grid gap-10 py-16 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <h2 className="mt-3 text-3xl">Getting to Alpine Crest in Theog</h2>
      ...
      <section className="container-page py-16">
        <div className="rounded-2xl bg-primary px-8 py-12 text-center text-primary-foreground">
          <h2 className="text-3xl">Book a Homestay Near Theog</h2>
